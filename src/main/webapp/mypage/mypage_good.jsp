		...
		$.ajax({
			...
			success : function(args) {
				...
				for (var i = 0; i < length; i++) {
					...
					var pageText = "";
					pageText += "<li><a style='background-color:#27AB99;color:#363636;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno=1')><i class='fa fa-angle-double-left'></i></a></li>";
					pageText += "<li><a style='color:#363636;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno="+ prev_pageno+"')><i class='fa fa-angle-left'></i></a></li>";
					for (var i = page_sno; i <= page_eno; i++) {
						pageText += "<li><a style='color:#363636;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno="+i+"')>";
						if (pageno == i) {
							pageText += "" + i + "";
							} else {
								pageText += "" + i + "";
						...
						pageText += "<li><a style='color:#363636;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno="+next_pageno+"')><i class='fa fa-angle-right'></i></a></li>";
						pageText += "<li><a style='background-color:#27AB99;color:#363636;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno="+total_page+"')><i class='fa fa-angle-double-right'></i></a></li><br class='paging'>";
	...
	function send(inputUrl) {
		...
		$.ajax({
			...
			success : function(args) {
				...
				var pageText = "";
				pageText += "<li><a style='background-color:#27AB99;color:#323A45;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno=1')><i class='fa fa-angle-double-left'></i></a></li>";
				pageText += "<li><a style='color:#323A45;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno="+prev_pageno+"')><i class='fa fa-angle-left'></i></a></li>";
				for (var i = page_sno; i <= page_eno; i++) {
					pageText += "<li><a style='color:#323A45;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno="+i+"')>";
					if (pageno == i) {
						pageText += "" + i + "";
					} else {
						pageText += "" + i + "";
				...
				pageText += "<li><a style='color:#323A45;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno="+next_pageno+"')><i class='fa fa-angle-right'></i></a></li>";
				pageText += "<li><a style='background-color:#27AB99;color:#323A45;margin-right:5px;' class='paging' href='#' onclick=send('${getMyGood }?pageno="+total_page+"')><i class='fa fa-angle-double-right'></i></a></li><br class='paging'>";
				$("#page").append(pageText);
			},
