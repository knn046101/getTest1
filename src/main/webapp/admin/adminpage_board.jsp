					...
					<div class="dividerHeading">
					 ...
					 <center>
          			  <div>
							...
							<input class="input-text" name="s" id="text" type="text" />
							<button id="search" style="background-color:#27AB99;color:#fff;border-style: none;"><i class="fa fa-search"></i></button>
						</div>
               		</div>
               		</center>
               		<br>
...
<c:url value="/getBoardByAdmin" var="getBoardByAdmin"/>
		...
		$.ajax({
			...
			success : function(args) {
				...
				for (var i = 0; i < length; i++) {
					...
					var page_per_record_cnt = 20; //페이지 당 레코드 수
	...
	<c:url value="/getBoardByAdminSearch" var="getBoardByAdminSearch"/> 
	$("#search").on("click", function(){
		...
		$.ajax({
			type : "get",
			url : "${getBoardByAdminSearch }?pageno=1",
			dataType : "json",
			data:data,
			success : function(args) {
				var length = args.length;
