...
/*추가  */
   <c:url value="/getBoardEditorBoards" var="getBoardEditorBoards"/>
	function getBoardEditorData(){
 /* 1. 처음 문서가 로딩될때 함수가 호출된다  
 2. 좋아요 수를 */
    	$.ajax({
        	url:"${getBoardEditorBoards}",
        	type:"get",
        	success:function(responseTxt){
            /*구분자  */
       		    var itemArray=JSON.parse(responseTxt); 
