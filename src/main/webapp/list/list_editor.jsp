		...
		<div class="row sub_content">
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="col-md-12" id="jcarousel recent-work-jc">
					<ul class="jcarousel-list" id="boardByEditor">
					</ul>
						...
						$
								.ajax({
									...
									success : function(args) {
										...
										pageText += "<a class='paging' href='#' onclick=send('${getEditorBoards }?pageno="
												+ prev_pageno + "')>[이전]</a>";
		...
		$
				.ajax({
					...
					success : function(args) {
						...
						pageText += "<a style='color:#323A45;' class='paging' href='#' onclick=send('${getEditorBoards }?pageno="
								+ prev_pageno + "')>[이전]</a>";
						for (var i = page_sno; i <= page_eno; i++) {
							pageText += "<a style='color:#323A45;' class='paging' href='#' onclick=send('${getEditorBoards }?pageno="
									+ i + "')>";
