...
<body>
		...
		<br>
		<button style="float:right;background-color:#27AB99;color:white;border-color:#fff;" onclick="location='../board/board_write.jsp'">글작성 <i class="fa fa-plus-square"></i></button>
		<br>
		<br>
