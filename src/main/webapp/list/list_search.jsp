                     ...
                     <div class="container">
                        <div class="row sub_content">
               			...
               			<div id="jcarousel recent-work-jc">
                        	 <ul class="jcarousel-list" id="boardBySearch" >
                       	 	</ul>
              		 	</div>
...
var category="";
   ...
   <c:url value="/getBoardsBySearch" var="getBoardsBySearch"/>
   $(document).ready(function(){
      ...
      $.ajax({
         type : "post",
         url : "${getBoardsBySearch }?pageno=1&location=${location}&numberOfPeople=${numberOfPeople}&category=${category}&what=${what}",
         dataType:"json",
