            ...
            <div class="row">
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="widget_title">
                        <h4><span>Team Information</span></h4>
                    </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="widget_title">
                        <h4><span>CUSTOMER CENTER</span></h4>
                    ...
                    <div class="widget_content">
                        <ul class="tweet_list">
                            ...
                            <li class="tweet_content item">
                                <i class="fa fa-leaf"></i>
                                <p class="tweet_link"><a href="#">BANK INFO </a><br>
                                 농협 111-2222-3333-44<br>
                                 국민 555-6666-7777-88<br>
                                 신한 999-1111-2222-33<br></p>
